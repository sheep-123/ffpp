<template>
	<view>
		...
		<!-- 	<view class="">
			...
			<map class="map-example"    :zIndex="-1" :latitude="nowAddInfo.latitude" :longitude="nowAddInfo.longitude" :markers="markers" :scale="18"  >
				<!-- 地图可视区域 204px -->
	...
	export default {
		...
		methods: {
			...
			pageScrollHandle(e) {
				...
				parseInt(detail.scrollTop) > 40 ? this.bgColor = '#fff' : this.bgColor = 'transparent';
			}
		}
	}
</script>
