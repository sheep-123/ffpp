      ...
      >
        ...
        >
          ...
          <scroll-view
            ...
            enhanced
            enable-back-to-top
            @scrolltolower="scrolltolowerHandel"
            :scroll-y="!isDragging || scrollDoFlag"
            :style="{ height: scrollViewHeight, 'z-index': 1 }"
            class="list-box"
          >
            <view class="main">
              <view
                class="item"
                @click="
                  $utils.toPath.navigateTo(
                    '/dynamic/publish/dongTaiDetail?newId=' + item.id
                  )
                "
...
export default {
  ...
  computed: {
    ...
    scrollViewHeight() {
      ...
      const marginToHeight = uni.upx2px(40);
      return `calc(100vh - ${
        this.scrollY + tabsHeight + pullHeight - marginToHeight
      }px)`;
    },
    isTopTabsShow() {
      return this.bgColor == "#fff";
  ...
  methods: {
    ...
    handleTouchMove(e) {
      if (
        e.stopPropagation &&
        this.scrollY == this.systemInfo.windowHeight - 3
      ) {
        event.stopPropagation();
      }
      if (!this.isDragging) {
    ...
    handleTouchEnd(e) {
      ...
      if (
        this.scrollY > mapHeight &&
        this.scrollY <=
          mapHeight + (this.systemInfo.windowHeight - mapHeight) / 2
      ) {
        this.toCenterHandle();
      }
      if (
...
>>>>>>> 056ac9b1acd55a8b08d297082c376f43f28ef9f3
</script>
