    ...
    <view>
      <scroll-view scroll-y :style="{ height: windowHeight - bottomBoxHeight - statusBarHeight - 44 + 'px' }">
        <view class="contentBox">
          ...
          <view class="tipsBox">
            ...
            <view class="box1">
              ...
              <image class="reloadIcon" src="@/static/reload.png" mode="scaleToFill" />
            </view>
          </view>
          <view class="textBox">
        ...
        <view class="siteSelectionBox">
          ...
          <view class="box2">
            <image class="top2Icon" src="@/static/top2.png" mode="scaleToFill" />
            <view class="scrollxBox">
              <scroll-view scroll-x style="width:100%;">
                <view class="cardBox">
                  <view class="card">红盾大厦</view>
                  <view class="card">体育西路(地铁站)</view>
                  <view class="card">CityNote希诺</view>
                  <view class="card">CityNote希诺</view>
                </view>
              </scroll-view>
            </view>
